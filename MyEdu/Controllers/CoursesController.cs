...
namespace MyEdu.Controllers
{
    ...
    public class CoursesController : ControllerBase
    {
        ...
        [HttpPost]
        public async ValueTask<ActionResult<BaseResponse<Course>>> PostCourseAsync([FromForm]CourseDto courseDto)
        {
        ...
        [HttpGet]
        public async ValueTask<ActionResult<BaseResponse<IQueryable<Course>>>> GetCoursesAsync([FromQuery] PaginationParams @params)
        {
        ...
        [HttpGet("{id}")]
        public async ValueTask<ActionResult<BaseResponse<Course>>> GetCourseAsync(long id)
        {
        ...
        [HttpPut("{id}")]
        public async ValueTask<ActionResult<BaseResponse<Course>>> PutCourseAsync(long id, CourseDto courseDto)
        {
        ...
        [HttpDelete("{id}")]
        public async ValueTask<ActionResult<BaseResponse<Course>>> DeleteCourseAsync(long id)
        {
